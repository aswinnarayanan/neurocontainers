...
echo "RUN emerge --sync --quiet" >> ${toolName}_${toolVersion}.Dockerfile
...
echo "RUN --security=insecure USE='python_targets_python3_7' emerge samri --autounmask-continue" >> ${toolName}_${toolVersion}.Dockerfile
